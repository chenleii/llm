...
# 相关文档
# https://segmentfault.com/a/1190000044537832
class S6(nn.Module):
    ...
    def forward(self, x):
        ...
        if DIFFERENT_H_STATES_RECURRENT_UPDATE_MECHANISM:
            ...
            if self.h.shape[0] != current_batch_size:
                ...
                h_new = (
                        torch.einsum('bldn,bldn->bldn', self.dA, self.h[:current_batch_size, ...])
...
class RMSNorm(nn.Module):
    def __init__(self, d_model: int, eps: float = 1e-5, device: str = device):
        super().__init__()
        self.eps = eps
